...
public class Vehicle {
	...
	public Vehicle(String marca, String model, int motor) {
		this.color = "verd";
		this.marca = marca;
		this.model = model;
		this.motor = motor;
		this.velocitat = 0;
		this.id = Vehicle.idSeguent;
		Vehicle.idSeguent = this.id + 1;
	}
	
	public Vehicle(String color, String marca, String model, int motor) {
		this.color = color;
		this.marca = marca;
		this.model = model;
		this.motor = motor;
